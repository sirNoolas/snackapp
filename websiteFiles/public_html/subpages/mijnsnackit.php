			...
			<div id="bodyrightdiv"><br /><b>Uw bestelling voor vandaag:</b><br /><br />
				<?php 
					...
					echo (
						"<table id=producttable>
		           		 <tr id=productfirstrow>
					         <td id=producttd style='background-color:#d22b44'>Product</td>                  	 	
					         <td id=producttd style='background-color:#d22b44'>Prijs (euro)</td>
					         <td id=producttd style='background-color:#d22b44'>Aantal</td>
					         <td id=producttd style='background-color:#d22b44'>Totaal product</td>
							 </tr>"
					);
					...
					if (mysql_affected_rows() == 1)
						...
						echo ("
							<tr>
								<td id=producttd colspan='4'><b> TOTAAL eindbedrag: €$totalvalue </b></td>
							</tr>"
							);
